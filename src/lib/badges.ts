...
import { Footprints, Award, Star, MapPin, Sparkles, Anchor, Sun, Mountain, Crown, Users, Eye } from 'lucide-react';
...
export const ALL_BADGES: BadgeData[] = [
  ...
  { id: 'team-player', name: 'Team Player', milestone: 1, description: 'You\'ve joined or created a team!', icon: Users },
  { id: 'social-butterfly', name: 'Social Butterfly', milestone: 1, description: 'You\'re exploring the community by viewing another user\'s profile!', icon: Eye },
];
