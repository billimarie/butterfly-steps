  ...
  return (
    <footer className="bg-muted/50 py-6 text-center text-sm text-muted-foreground">
      <div className="container mx-auto px-4">
        <p>&copy; {currentYear} Butterfly Steps by <a href="https://foreveryStaratree.org/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline ml-1">For Every Star, A Tree</a>. All rights reserved.</p>
        <p className="mt-1">
